    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("kiwipete", 4_595_697),
                ("perft 4", 4_039_619),
                ("promotions", 2_595_576),
                ("middlegame", 3_928_778),
                ("sharp middlegame", 10_948_016),
                ("bratko kopec 1", 717_603),
                ("wac 4", 2_288_408),
                ("rook and pawns", 173_579),
                ("tarrasch", 433_511),
                ("lucena", 521_834),
                ("philidor", 897_504),
                ("minor endgame", 141_690),
                ("queen endgame", 2_289_764),
                ("king and pawn", 9_196),
                ("trebuchet", 3_264),
            ]
        );
