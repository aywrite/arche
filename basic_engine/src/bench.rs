    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("kiwipete", 4_159_543),
                ("perft 4", 3_552_956),
                ("promotions", 2_196_865),
                ("middlegame", 3_609_195),
                ("sharp middlegame", 10_316_114),
                ("bratko kopec 1", 673_784),
                ("wac 4", 2_086_739),
                ("rook and pawns", 157_604),
                ("tarrasch", 416_927),
                ("lucena", 772_972),
                ("philidor", 813_305),
                ("minor endgame", 129_565),
                ("queen endgame", 1_565_321),
                ("king and pawn", 8_693),
                ("trebuchet", 3_264),
            ]
        );
    ...
    fn reference_node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 109_921),
                ("middlegame", 209_213),
                ("sharp middlegame", 327_727),
                ("bratko kopec 1", 60_591),
                ("wac 4", 98_887),
                ("rook and pawns", 18_966),
                ("tarrasch", 56_188),
                ("lucena", 32_924),
                ("philidor", 44_596),
                ("minor endgame", 13_565),
                ("queen endgame", 80_021),
                ("king and pawn", 1_548),
                ("trebuchet", 627),
            ]
        );
