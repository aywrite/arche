    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("kiwipete", 4_636_654),
                ("perft 4", 4_063_039),
                ("promotions", 2_606_958),
                ("middlegame", 3_986_236),
                ("sharp middlegame", 11_130_080),
                ("bratko kopec 1", 718_283),
                ("wac 4", 2_297_043),
                ("rook and pawns", 173_653),
                ("tarrasch", 433_866),
                ("lucena", 523_625),
                ("philidor", 903_894),
                ("minor endgame", 142_772),
                ("queen endgame", 2_341_395),
                ("king and pawn", 9_196),
                ("trebuchet", 3_264),
            ]
        );
