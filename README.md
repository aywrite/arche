...
null move pass, and late move reductions and pruning off the node's depth and the move's place in
the order. Captures are ordered by what a static exchange evaluation says the swap wins, with
