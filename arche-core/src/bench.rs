    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 59_660),
                ("middlegame", 118_357),
                ("sharp middlegame", 184_051),
                ("bratko kopec 1", 678_700),
                ("wac 4", 2_046_349),
                ("rook and pawns", 29_732),
                ("tarrasch", 28_589),
                ("lucena", 15_601),
                ("philidor", 61_052),
                ("minor endgame", 15_479),
                ("queen endgame", 110_617),
                ("king and pawn", 3_937),
                ("trebuchet", 2_862),
            ]
        );
    ...
    fn reference_node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 102_115),
                ("middlegame", 166_455),
                ("sharp middlegame", 248_949),
                ("bratko kopec 1", 47_796),
                ("wac 4", 89_395),
                ("rook and pawns", 24_464),
                ("tarrasch", 40_314),
                ("lucena", 22_041),
                ("philidor", 100_070),
                ("minor endgame", 15_143),
                ("queen endgame", 99_469),
                ("king and pawn", 1_685),
                ("trebuchet", 961),
            ]
        );
