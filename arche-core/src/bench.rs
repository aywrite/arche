    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 113_681),
                ("middlegame", 302_184),
                ("sharp middlegame", 1_160_656),
                ("bratko kopec 1", 619_662),
                ("wac 4", 2_099_671),
                ("rook and pawns", 59_461),
                ("tarrasch", 50_976),
                ("lucena", 27_963),
                ("philidor", 89_894),
                ("minor endgame", 47_098),
                ("queen endgame", 211_014),
                ("king and pawn", 3_534),
                ("trebuchet", 2_577),
            ]
        );
    ...
    fn reference_node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 111_049),
                ("middlegame", 155_556),
                ("sharp middlegame", 506_094),
                ("bratko kopec 1", 56_877),
                ("wac 4", 99_364),
                ("rook and pawns", 27_377),
                ("tarrasch", 25_882),
                ("lucena", 19_087),
                ("philidor", 38_826),
                ("minor endgame", 23_549),
