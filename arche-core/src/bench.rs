    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 46_930),
                ("middlegame", 117_197),
                ("sharp middlegame", 176_633),
                ("bratko kopec 1", 630_034),
                ("wac 4", 1_941_201),
                ("rook and pawns", 28_442),
                ("tarrasch", 90_980),
                ("lucena", 15_465),
                ("philidor", 61_106),
                ("minor endgame", 25_234),
                ("queen endgame", 56_696),
                ("king and pawn", 3_522),
                ("trebuchet", 2_834),
            ]
        );
    ...
    fn reference_node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 95_256),
                ("middlegame", 167_368),
                ("sharp middlegame", 272_350),
                ("bratko kopec 1", 50_953),
                ("wac 4", 89_419),
                ("rook and pawns", 23_972),
                ("tarrasch", 33_182),
                ("lucena", 21_204),
                ("philidor", 51_857),
                ("minor endgame", 33_564),
                ("queen endgame", 96_557),
                ("king and pawn", 1_601),
                ("trebuchet", 968),
            ]
        );
