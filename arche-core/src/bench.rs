    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 54_363),
                ("middlegame", 100_507),
                ("sharp middlegame", 180_608),
                ("bratko kopec 1", 571_361),
                ("wac 4", 1_944_432),
                ("rook and pawns", 29_021),
                ("tarrasch", 89_870),
                ("lucena", 15_468),
                ("philidor", 61_191),
                ("minor endgame", 25_367),
    ...
    fn reference_node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 95_254),
                ("middlegame", 167_371),
                ("sharp middlegame", 277_951),
                ("bratko kopec 1", 44_544),
                ("wac 4", 89_394),
                ("rook and pawns", 24_020),
                ("tarrasch", 33_182),
                ("lucena", 21_127),
                ("philidor", 51_857),
                ("minor endgame", 34_141),
                ("queen endgame", 96_523),
                ("king and pawn", 1_601),
                ("trebuchet", 968),
            ]
        );
