    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 57_443),
                ("middlegame", 118_436),
                ("sharp middlegame", 177_936),
                ("bratko kopec 1", 785_872),
                ("wac 4", 1_959_097),
                ("rook and pawns", 30_011),
                ("tarrasch", 51_639),
                ("lucena", 15_589),
                ("philidor", 61_016),
                ("minor endgame", 25_487),
                ("queen endgame", 100_143),
                ("king and pawn", 3_522),
                ("trebuchet", 2_834),
            ]
        );
    ...
    fn reference_node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 95_140),
                ("middlegame", 165_027),
                ("sharp middlegame", 342_621),
                ("bratko kopec 1", 51_421),
                ("wac 4", 89_375),
                ("rook and pawns", 23_286),
                ("tarrasch", 59_044),
                ("lucena", 20_545),
                ("philidor", 35_656),
                ("minor endgame", 33_245),
                ("queen endgame", 99_210),
                ("king and pawn", 1_601),
                ("trebuchet", 968),
            ]
        );
