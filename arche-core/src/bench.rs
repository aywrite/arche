    ...
    fn node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 55_437),
                ("middlegame", 123_679),
                ("sharp middlegame", 204_993),
                ("bratko kopec 1", 570_627),
                ("wac 4", 1_958_677),
                ("rook and pawns", 31_750),
                ("tarrasch", 29_901),
                ("lucena", 15_136),
                ("philidor", 53_883),
                ("minor endgame", 28_361),
    ...
    fn reference_node_counts_have_not_moved() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("promotions", 95_317),
                ("middlegame", 167_437),
                ("sharp middlegame", 377_165),
                ("bratko kopec 1", 44_467),
                ("wac 4", 89_371),
                ("rook and pawns", 24_904),
                ("tarrasch", 39_425),
                ("lucena", 20_558),
                ("philidor", 32_477),
                ("minor endgame", 33_223),
