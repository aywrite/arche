...
use arche_core::{AlphaBeta, Board, Color, Engine, SearchParameters};

const TEST_POSITIONS: [&str; 4] = [
    arche_core::STARTING_FEN, // initial
...
bench_engine_fen!(
    ...
    { engine.iterative_deepening_search(SearchParameters::to_depth(5), |_, _, _| {}) }
);
