...
company with the reference in five places today: the fifty move guard,
reverse futility, the null move pass, the delta margin in quiescence, and
the killers and history table the quiet moves are ordered by.
